...
class StageLoader:
    ...
    def load_stage(self, stage_number: int) -> BaseStage:
        ...
        stage_map = {
            0: "weaver.stages.stage_0_input_acquisition",
            1: "weaver.stages.stage_1_canonical_normalization",
            2: "weaver.stages.stage_2_structural_intent",
            3: "weaver.stages.stage_3_diffusion_refinement",
            4: "weaver.stages.stage_4_repeat_enforcement",
            5: "weaver.stages.stage_5_geometry_cleanup",
            6: "weaver.stages.stage_6_color_constraint",
            7: "weaver.stages.stage_7_precam_validation",
        }
