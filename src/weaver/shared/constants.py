...
# File formats - LOSSLESS ONLY (manufacturing mandate)
...
# Color modes - UNAMBIGUOUS ONLY (manufacturing mandate)
...
# Input Acquisition - Manufacturing constraint thresholds
...
DIFFUSION_STAGE_TIMEOUT: Final[float] = 1800.0  # 30 minutes for diffusion refinement
